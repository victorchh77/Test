...
const services = [
  { icon: Wallet,      title: 'Financiación a medida', desc: 'Planes en guaraníes o dólares, cuotas que se ajustan a tu presupuesto y aprobación ágil.' },
  ...
  { icon: Gauge,       title: 'Inspección certificada', desc: 'Historial de kilometraje y estado real verificado. Comprás con información, no con promesas.' },
]
          ...
          <Reveal>
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                'Financiación propia y con entidades aliadas',
        ...
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10">
          <Reveal>
            ...
            <ul className="mt-8 space-y-4">
              <ContactRow icon={MapPin}  label="Dirección" value="Av. Dr. Francia, Encarnación, Itapúa" />
              <ContactRow icon={Phone}   label="Teléfono"  value="+595 (0)71 000 000" />
              <ContactRow icon={Mail}    label="Email"     value="ventas@vhgroup.com.py" />
              <ContactRow icon={Clock}   label="Horario"   value="Lun a Vie 8:00–18:00 · Sáb 8:00–12:00" />
            </ul>
          </Reveal>
        ...
        <div className="grid gap-10 md:grid-cols-[1.5fr_1fr_1fr]">
          <div>
            ...
            <div className="mt-5 flex items-center gap-3">
              <Social label="WhatsApp" href="https://wa.me/595000000000">
          ...
          <FooterCol title="Empresa" links={[
            ...
            { label: 'WhatsApp', href: 'https://wa.me/595000000000' },
            { label: 'ventas@vhgroup.com.py', href: 'mailto:ventas@vhgroup.com.py' },
          ]} />
        </div>
