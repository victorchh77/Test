...
export function NuevoVehiculoForm({ canSeePrecioCompra }: { canSeePrecioCompra: boolean }) {
  ...
  return (
    <div className="max-w-2xl mx-auto flex flex-col gap-5 animate-fade-in">
      ...
      <Card>
        <VehicleForm onSubmit={handleSubmit} loading={loading} error={error} canSeePrecioCompra={canSeePrecioCompra} />
      </Card>
    </div>
  )
}
